  Jargo.Router = Backbone.Router.extend({
    initialize: function(options){
      this.el = options.el;
      this.movies = options.movies;
    },
    routes:{
      //router will match the REST URL and call the appropriate action,
    ...
    index: function(){
      ...
      var movieListView = new Jargo.MovieListView({movies:this.movies});
    ...
    showMovieDetail: function(name){
      var movieDetailView = new Jargo.MovieDetailView({movies: this.movies, movieName: name });
